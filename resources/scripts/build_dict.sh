...
if [ $version_major -eq 5 ]
  then
    rootcint -f ${OUTFILE} -c -p -I../cmds -I../core -I../loop -I../loop/decoder -I../../core -I../../loop -I../../loop/decoder $@
...
#>   rootcint -f $2 -rmf $3 -rml $lib_name -I../Core -I../Physics -I../../Core -I../../Physics $1 $5
    rootcint -f ${OUTFILE} -c -p -I../cmds -I../../cmds -I../core -I../loop -I../loop/decoder -I../../core -I../../loop -I../../loop/decoder $@
    ###<../cmds for compile in source dir while ../../cmds for compile in build dir>###
fi
