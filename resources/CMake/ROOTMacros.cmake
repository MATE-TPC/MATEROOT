...
Macro(ROOT_GENERATE_DICTIONARY_NEW)
  ...
  ELSE(FAIRROOTPATH)
    Configure_File(${PROJECT_SOURCE_DIR}/ressources/CMake/scripts/generate_dictionary_root.sh.in
                   ${CMAKE_CURRENT_BINARY_DIR}/generate_dictionary_${script_name}.sh
                  )
  ENDIF(FAIRROOTPATH)
...
MACRO (GENERATE_ROOT_TEST_SCRIPT SCRIPT_FULL_NAME)
  ...
  ELSE(FAIRROOTPATH)
    configure_file(${PROJECT_SOURCE_DIR}/ressources/CMake/scripts/root_macro.sh.in
                   ${new_path}/${shell_script_name}
                  )
  ENDIF(FAIRROOTPATH)
...
Macro(GENERATE_LIBRARY)
  ...
  set_target_properties(${Int_LIB} PROPERTIES OUTPUT_NAME) #> add OUTPUT_NAME
  #set_target_properties(${Int_LIB} PROPERTIES OUTPUT_NAME ${FAIRROOT_LIBRARY_PROPERTIES})
